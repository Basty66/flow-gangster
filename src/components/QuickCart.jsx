...
export default function QuickCart() {
  ...
  return (
    <>
      ...
      <div className={`fixed top-0 right-0 h-full w-full max-w-md bg-deep border-l border-white/5
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <button onClick={() => removeItem(idx)}
                              className="ml-auto text-[#525252] hover:text-red-400 transition-colors">
                        <TrashIcon />
                      </button>
                    </div>
                  </div>
